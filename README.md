...
package also exposes two versioned design-system contracts and a serializable Layout Shell catalog
with a deterministic render-contract hash. See the
[Evolution CLI overview](./docs/schematics.md#public-layout-shell-catalog) and
...
The current release candidate is `v0.10.1-alpha.0`.
