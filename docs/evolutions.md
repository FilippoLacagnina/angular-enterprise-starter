...
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- | ------------- | ---------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------- | ----------- |
| [`evo/i18n/transloco`](https://github.com/FilippoLacagnina/angular-enterprise-starter/tree/evo/i18n/transloco)                                 | [Guide](./evolutions/i18n-transloco.md)        | i18n          | Runtime translation baseline with Transloco, static assets and docs.   | `v0.5.0-alpha.0`    | `package.json`, `package-lock.json`, `angular.json`, `app.config.ts`            | Implemented |
